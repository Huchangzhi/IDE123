...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "product" "nameShort" "123IDE - Insiders"
  setpath "product" "nameLong" "123IDE - Insiders"
  setpath "product" "applicationName" "codium-insiders"
  setpath "product" "dataFolderName" ".123IDE-insiders"
  setpath "product" "linuxIconName" "vscodium-insiders"
  setpath "product" "quality" "insider"
  setpath "product" "urlProtocol" "123IDE-insiders"
  setpath "product" "serverApplicationName" "codium-server-insiders"
  setpath "product" "serverDataFolderName" ".123IDE-server-insiders"
  ...
  setpath "product" "win32DirName" "123IDE Insiders"
  setpath "product" "win32MutexName" "123IDEinsiders"
  setpath "product" "win32NameVersion" "123IDE Insiders"
  setpath "product" "win32RegValueName" "123IDEInsiders"
  setpath "product" "win32ShellNameShort" "123IDE Insiders"
  ...
  setpath "product" "nameShort" "123IDE"
  setpath "product" "nameLong" "123IDE"
  setpath "product" "applicationName" "123IDE"
  setpath "product" "linuxIconName" "vscodium"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "123IDE"
  setpath "product" "serverApplicationName" "123IDE-server"
  setpath "product" "serverDataFolderName" ".123IDE"
  setpath "product" "darwinBundleIdentifier" "com.123IDE"
  setpath "product" "win32AppUserModelId" "123IDE.123IDE"
  setpath "product" "win32DirName" "123IDE"
  setpath "product" "win32MutexName" "123IDE"
  setpath "product" "win32NameVersion" "123IDE"
  setpath "product" "win32RegValueName" "123IDE"
  setpath "product" "win32ShellNameShort" "123IDE"
